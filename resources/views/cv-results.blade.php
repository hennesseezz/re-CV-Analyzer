...
<body class="bg-gray-50 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-8">
            ...
            <a href="{{ route('home') }}" class="inline-block mt-4 text-blue-600 hover:text-blue-800 underline">← Analyze Another CV</a>
        </div>
        ...
        <!-- Feedback Section -->
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 mb-8">
            <h3 class="text-lg font-semibold mb-2 text-gray-800">User Feedback</h3>

            <textarea
                id="user-notes"
                class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 resize-none"
                rows="5"
            ...
            <div class="mt-4 p-3 bg-gray-50 border border-gray-200 rounded-md">
                <h4 class="font-medium text-gray-700 mb-1">Saved Notes:</h4>
