...
<head>
    ...
    <title>Create Job Description - CV Analyzer</title>
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Create Job Description</h2>
                        <p class="text-gray-600">Add a new job description for CV matching</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-8">
                ...
                <form action="{{ route('admin.job-desc.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" 
                                  ...
                                  required
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                                  placeholder="Describe the job position...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="responsibilities" 
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                                  placeholder="List the job responsibilities...">{{ old('responsibilities') }}</textarea>
                    </div>

                    <!-- Skills Required -->
                    <div class="mb-6">
                        <label for="skills_required" class="block text-sm font-semibold text-gray-700 mb-2">Skills Required</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select id="experience_level" 
                                ...
                                <option value="Mid-Level" {{ old('experience_level') == 'Mid-Level' ? 'selected' : '' }}>Mid-Level (3-5 years)</option>
